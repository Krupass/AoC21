...
def mark_field(lines, field):
    for line in lines:
        if(line[0][0] == line[1][0]):
            if(line[0][1] > line[1][1]):
                for i in range(line[1][1],line[0][1]+1):
                    field[line[0][0]][i] = field[line[0][0]][i] + 1
            else:
            ...
            if(line[0][0] > line[1][0]):
                for i in range(line[1][0],line[0][0]+1):
                    field[i][line[0][1]] = field[i][line[0][1]] + 1
            else:
                for i in range(line[0][0],line[1][0]+1):
                    field[i][line[0][1]] = field[i][line[0][1]] + 1
        #for part one delete else under this
        else:
            if(line[0][0] > line[1][0] and line[0][1] > line[1][1]):
                i = line[1][0]
                j = line[1][1]
                while(i <= line[0][0] and j <= line[0][1]):
                ...
                i = line[1][0]
                j = line[0][1]
                while (i <= line[0][0] and j <= line[1][1]):
                    field[i][j] = field[i][j] + 1
                    i = i + 1
                    j = j + 1
            elif(line[0][0] < line[1][0] and line[0][1] > line[1][1]):
                i = line[0][0]
                j = line[1][1]
                while (i <= line[1][0] and j <= line[0][1]):
                    field[i][j] = field[i][j] + 1
                    i = i + 1
                    j = j + 1
            else:
                i = line[0][0]
                j = line[0][1]
                while (i <= line[1][0] and j <= line[1][1]):
                    field[i][j] = field[i][j] + 1
                    i = i + 1
                    j = j + 1

def higher_than(field, value):
    count = 0
    for line in field:
...
for i in range(0,1000):
    ...
    for j in range(0,1000):
        zero_field[i].append(0)

mark_field(lines,zero_field)
#print(zero_field[656])
#print(zero_field[657])
#print(zero_field[658])

for part in zero_field:
    field = []
    for i in range(0,1000):
        field.append(0)
    if(part != field):
...
print("Higher or equal 2: " + str(higher_than(zero_field,2)))